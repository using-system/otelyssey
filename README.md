...
- [oddyssey](marketplace/oddyssey/README.md) by [using-system](https://github.com/using-system) - Observability-Driven Development for CLI coding agents · also in Instrumentation, Backends  
