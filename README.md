...
- [sentry](https://github.com/getsentry/agent-plugin) by [Sentry](https://sentry.io) - Set up Sentry, debug production issues, and configure application monitoring: skills to debug an issue, fix stack traces, create alerts and set up releases, with the Sentry MCP server; Sentry ingests OpenTelemetry natively over OTLP. · [install](marketplace/sentry/README.md)  
