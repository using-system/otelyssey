...
- gh-aw workflows are committed as `.md` with their compiled `.lock.yml` and the `agentics-maintenance.yml` the compiler generates; CI compiles again and refuses a drift.
...
.github/workflows/agentics-maintenance.yml    generated by gh aw compile, committed
